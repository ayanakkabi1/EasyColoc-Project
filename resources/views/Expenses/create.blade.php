                    ...
                    <form method="POST" action="{{ route('expenses.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="spent_at" class="block mt-1 w-full" type="date" name="spent_at" :value="old('spent_at', date('Y-m-d'))" required />
                        ...
                        <div>
                            ...
                            <select name="category" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                                <option value="Courses">Courses alimentaire</option>
                        ...
                        <div>
                            ...
                            <textarea name="description" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" rows="3">{{ old('description') }}</textarea>
                        </div>
